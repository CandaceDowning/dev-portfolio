...
const Portfolio = ({ classicHeader, darkTheme }) => {
  ...
  const projectsData = [
...

    {
      ...
      client: "Eatzi's",
      technologies: "Wordpress, Woocommerce, React, Wordpress API, Woocommerce API, Php, Javascript, JQuery, Bootstrap, Sass, styled components",
      industry: "Art & Design",
      date: "July 16, 2019",
      url: {
        name: "eatzis.com/",
    ...
    },
    {
      ...
      technologies: "Wordpress, Woocommerce, Express, digital ocean, Olo Api, Worldpay Api, Php, Javascript, JQuery, Bootstrap, Sass",
      industry: "Art & Design",
      date: "July 16, 2019",
      url: {
    ...
    },
    {
      ...
      technologies: "React, Express, Heroku, Node, SCSS, Redux, bcrypt, Postgress, Redux, CSS, Javascript",
      industry: "Art & Design",
      date: "July 16, 2019",
      url: {
        name: "Github",
    ...
    },
    {
      ...
      technologies: "React, Express, Heroku, Node, SCSS, Redux, bcrypt, PostgreSQL, Redux, CSS, Javascript",
      industry: "Art & Design",
      date: "July 16, 2019",
      url: {
        name: "Github",
    ...
    },
    {
      ...
      client: "Student Solo Project",
      technologies: "iReact, Axios, Express, Javascript, CSS",
      industry: "Art & Design",
      date: "July 16, 2019",
      url: {
        name: "Github",
