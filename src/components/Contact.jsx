...
const Contact = ({ classicHeader, darkTheme }) => {
  ...
  // uses www.emailjs.com for connecting to gmail
  const sendEmail = (e) => {
    e.preventDefault();
    setSendingMail(true);
    emailjs
      ...
      <div className={"container " + (classicHeader ? "" : "px-lg-5")}>
        ...
        <div className="row gy-5">
          ...
          <div className="col-md-4 col-xl-3 order-1 order-md-0 text-center text-md-start">
            ...
            <p className={"text-3 mb-4 " + (darkTheme ? "text-light" : "")}>
              <a href="mailto: candacedowning@gmail.com?subject=Contact from candacedowning.dev" target="_blank">
                <span className="text-primary text-4 me-2">
                  <i className="fas fa-envelope" />
                </span>
                candacedowning@gmail.com
                </a>
            </p>
            <h2
              className={
            ...
            >
              ...
              {/* added color to variables for default pink and set these classes to it */}
              <li className="social-icons-github">
                <Tooltip text="Github" placement="top">
                  <a
                    href="https://github.com/CandaceDowning"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
